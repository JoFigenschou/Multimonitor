 ...
 * Syncs transform to a target actor when assigned.
 */
...
public:
	...
	void Configure(AActor* InViewTarget, UTextureRenderTarget2D* InRenderTarget, const FIntPoint& FallbackResolution);
